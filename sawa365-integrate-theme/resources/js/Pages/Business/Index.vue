                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div>
                            <div class="flex justify-start gap-4 items-center">
                                ...
                                <div class="flex items-center mb-3 mt-6 px-2">
                                    ...
                                    <label for="hs-xs-switch"
                                        class="text-sm text-gray-500 ms-3 dark:text-neutral-400">Show Map</label>
                                </div>
                            </div>

                            <div class="px-1 py-5 sm:px-6 lg:px-4 lg:py-4 mx-auto">
                                <!-- Grid -->
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 h-screen">
                                    <div class="col-span-1 overflow-y-scroll px-3">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 lg:grid-cols-1 ">
                                            <!-- start user card -->
                                            <div
                                                class="flex flex-col rounded-xl p-2 md:p-2 my-2 bg-white border border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
