                        ...
                        <div>
                            ...
                            <div class="px-4 py-5 sm:px-6 lg:px-4 lg:py-4 mx-auto">
                                ...
                                <div>
                                    ...
                                    <!-- start card -->
                                    <div v-if="user_groups[0].groups.length == 0" class="min-h-32 w-full shadow-md rounded-lg border p-3 flex justify-center items-center">
                        ...
                        <div>
                            ...
                            <div class="px-4 py-5 sm:px-6 lg:px-4 lg:py-4 mx-auto">
                                ...
                                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                    <!-- card -->
                                    <Card v-for="group in all_groups" :key="group.id" 
                                    :imageSrc="group.img"
                                        :goTo="route('groups.my-group.index',{name:group.name})">
                                        <template #header>
                                            {{ group.name }}
